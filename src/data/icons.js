...
export const FEAT_ICONS = {
  ...
  spellfocustrans: '🌗',
  spellfocusill: '🎭',
  greaterspellfocusabj: '🛡️',
  greaterspellfocuscon: '🌀',
  greaterspellfocusdiv: '🔮',
  greaterspellfocusenc: '💫',
  greaterspellfocusevo: '🔥',
  greaterspellfocusnec: '☠️',
  greaterspellfocustrans: '🌗',
  greaterspellfocusill: '🎭',
  spellpenetration: '🗡️',
  greaterspellpen: '🗡️',
  ...
  devastatingcritical: '☠️',
  improvedwhirlwindattack: '🌀',
  superiorinitiative: '⚡',
  blindingspeed: '💨',
  improvedsneakattack: '🗡️',
  improvedstunningfist: '👊',
  greatsmiting: '🔨',
  epicreputation: '📣',
  epicskillfocus: '🏆',
  epicspellfocus: '✨',
  epicspellpenetration: '🗡️',
  improvedcombatcasting: '🧘',
  automaticquickenspell: '⏱️',
